...
def processPlaylist(playlistLink, baseOutputPath):
    ...
    # start threads, default set to 5
    with ThreadPoolExecutor(max_workers=5) as executor:
        futures = [executor.submit(downloadAndProcessTrack, track, playlistDir, index) for index, track in enumerate(playlistData)]
...
def downloadAndProcessTrack(track, playlistDir, index):
...
def autoImport2AppleMusic(playlistDir):
    try:
        musicDir = "Add your Music Directory Location Here"
...
outputPath = "Add your output path"
